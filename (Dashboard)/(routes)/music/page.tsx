...
import Empty from "@/components/Music";
 ...
 const onSubit =async (values:z.infer<typeof formschema>) => {
  ...
  return (
    <div>
       ...
       description="Turn your thoughts into music."
       icon={Music}
              ...
              render={({field}) =>(
                <FormItem className="col-span-12 lg:col-span-10">
                    <FormControl className="m-0 p-0">
                      ...
                      disabled={isLoading}
                      placeholder="Turn  your prompt into music ..."
                      {...field}
                      />
                    </FormControl>
                </FormItem>
          ...
          <div className="space-y-4 mt-4">
            {isLoading &&(
              <div className="p-8 rounded-lg w-full fex items-center justify-center bg-muted">
               ...
               {!music  && !isLoading &&(
               <Musicpage label="No music generated yet!" />
               )}
                 {music && (
